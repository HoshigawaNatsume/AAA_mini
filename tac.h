...
typedef struct sym
{
	...
	*/
	...
	int array_flag; // 变量是否为数组
	int array_address_flag; // 变量是否是数组首地址
	int array_size; // 数组大小/长度
	int array_offset; // 偏移量
	int array_offset_right;//右值偏移量
	int formal_flag;
	int pointer_flag;
} SYM;
